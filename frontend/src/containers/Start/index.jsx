...
function Start(){
    ...
    return (
        <section className='center'> 
            <Scene type="basic"/>
            <Hint character="rat" text="Kosmiczna technologia zagraża światu. Ekrany dotykowe opanowały nasze umysły. Już teraz potrzebujemy nowego pokolenia, które będzie w stanie stawić czoła wyzwaniom przyszłości." right />
