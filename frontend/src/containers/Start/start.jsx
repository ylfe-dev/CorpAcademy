    ...
    return (
        <Scene type="start"> 
            ...
            <section className='content'>
                ...
                <Hint character="cat" delay="4" text="Ja nazywam się Fat Cat, a ten wyżej to Smart Rat, wspólnie pomożemy Ci nauczyć się pisać na klawiaturze, korzystać z myszki, a nawet języka angielskiego. Zostań mistrzem klawiatury i uratuj świat!"/>
            </section>
