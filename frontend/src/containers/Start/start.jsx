    ...
    return (
        <Scene type="start"> 
            ...
            <section className='content'>
                ...
                <Hint character="cat" right delay="5s" text="Ja nazywam się Fat Cat, a ten wyżej to Smart Rat, wspólnie pomożemy Ci nauczyć się pisać na klawiaturze, korzystać z myszki, a nawet programować w Pythonie. Zostań mistrzem klawiatury i uratuj świat!"/>
            </section>
